package ac.id.atmaluhur.gmapsdb;
...
import ac.id.atmaluhur.gmapsdb.api.ApiClient;
import ac.id.atmaluhur.gmapsdb.api.ApiService;
import ac.id.atmaluhur.gmapsdb.model.ListLocationModel;
import ac.id.atmaluhur.gmapsdb.model.LocationModel;
...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        //diarahin ke class getalldatalocationlating
    ...
    private void initMarker(List<LocationModel> ListData) {
        //literasi semua data dan tampilkan markernya
